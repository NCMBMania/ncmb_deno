...
class NCMBRequest {
    ...
    async get(className: string, queries = {}): Promise<NCMBObject[]> {
        const result = await this.exec("GET", className, queries) as {
            [s: string]: any;
        };
    ...
    async post(className: string, data: object | FormData = {}): Promise<{
        [s: string]: any;
    }> {
        return await this.exec("POST", className, {}, data) as {
            [s: string]: any;
        };
    }
    async put(className: string, data = {}, objectId: string): Promise<{
        ...
        return await this.exec("PUT", className, {}, data, objectId) as {
            [s: string]: any;
        };
    }
