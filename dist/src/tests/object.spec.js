...
describe('Object test:', function () {
    ...
    it('Save object', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    hello = new index_1.NCMBObject('Hello');
    ...
    it('Update object', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    hello2 = new index_1.NCMBObject('Hello');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    Hello = new index_1.NCMBQuery('Hello');
                    return [4 /*yield*/, Hello
                            .include('hello')
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, user_1["default"].login('admin', 'admin')];
                case 2:
                    _a.sent();
                    hello.fetch();
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, user_1["default"].logout()];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    hello = new index_1.NCMBObject('Hello');
                    lat = 35.6585805;
                    geo = new index_1.NCMBGeoPoint(lat, 139.7454329);
                    hello
                        .set('geo', geo)
                        .save();
                    return [4 /*yield*/, hello.fetch()];
                case 1:
                    _a.sent();
                    assert.equal(hello.get('geo') instanceof index_1.NCMBGeoPoint, true);
