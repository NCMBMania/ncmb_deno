...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                obj1 = new index_1.NCMBObject('Hello');
                return [4 /*yield*/, obj1
                        .set('num', 1)
                        .save()];
            case 1:
                _a.sent();
                obj2 = new index_1.NCMBObject('Hello');
                return [4 /*yield*/, obj2
                        .set('num', 2)
                        .save()];
            case 2:
            ...
            case 3:
                _a.sent();
                query = new index_1.NCMBQuery('Hello');
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query1 = new index_1.NCMBQuery('QueryTest');
                query1.lessThan('date', new Date(2020, 8, 16, 9, 0, 0));
                query2 = new index_1.NCMBQuery('QueryTest');
