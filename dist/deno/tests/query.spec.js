        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    obj = new index_ts_1.NCMBObject("QueryTest");
                    return [4 /*yield*/, obj
                            .set("number", i)
                            .save()];
                case 2:
            ...
            switch (_a.label) {
                case 0:
                    ...
                    for (index = 0; index < 5; index++) {
                        i = new index_ts_1.NCMBObject("Test");
                        promises.push(i
                            .set("string", "I'm item #" + index)
                            .set("number", index)
                            .save());
                        j = new index_ts_1.NCMBObject("Test2");
                        promises.push(j
                ...
                case 1:
                    _a.sent();
                    queryTest = new index_ts_1.NCMBQuery("Test");
                    queryTest2 = new index_ts_1.NCMBQuery("Test2");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    ary2 = [];
                    for (index = 0; index < 5; index++) {
                        i = new index_ts_1.NCMBObject("Test2");
                        promises2.push(i
                            .set("string", "I'm test2 #" + index)
                            .set("num", ary[index])
                            .save());
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    name_1 = _a[_i];
                    query = new index_ts_1.NCMBQuery(name_1);
