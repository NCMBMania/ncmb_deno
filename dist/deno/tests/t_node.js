...
var hello = new index_ts_1.NCMBObject("HelloDeno");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                geo = new index_ts_1.NCMBGeoPoint(35, 100);
                hello2 = new index_ts_1.NCMBObject("HelloDeno");
            ...
            case 4:
                _a.sent();
                query = new index_ts_1.NCMBQuery("HelloDeno");
            ...
            case 5:
                results = _a.sent();
                console.log(results);
                d = new index_ts_1.NCMBObject("HelloDeno");
