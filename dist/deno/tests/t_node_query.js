...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query = new index_ts_1.NCMBQuery("QueryTest");
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var query, _a, count, results;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                query = new index_ts_1.NCMBQuery("QueryTest");
                return [4 /*yield*/, query.fetchWithCount()];
            case 1:
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var obj1, obj2, query, ary;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                obj1 = new index_ts_1.NCMBObject("Hello");
                return [4 /*yield*/, obj1
                        .set("num", 1)
                        .save()];
            case 1:
                _a.sent();
                obj2 = new index_ts_1.NCMBObject("Hello");
                return [4 /*yield*/, obj2
                        .set("num", 2)
                        .save()];
            case 2:
            ...
            case 3:
                _a.sent();
                query = new index_ts_1.NCMBQuery("Hello");
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var query1, query2, query, ary;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                query1 = new index_ts_1.NCMBQuery("QueryTest");
                query1.lessThan("date", new Date(2020, 8, 16, 9, 0, 0));
                query2 = new index_ts_1.NCMBQuery("QueryTest");
                query2.lessThanOrEqualTo("number", 200);
                query = new index_ts_1.NCMBQuery("QueryTest");
                return [4 /*yield*/, query.or([query1, query2]).fetchAll()];
            case 1:
                ary = _a.sent();
                console.log(ary);
                return [2 /*return*/];
