...
var NCMBPush = /** @class */ (function (_super) {
    ...
    NCMBPush.query = function () {
        return new index_ts_1.NCMBQuery("push");
    };
    NCMBPush.prototype.set = function (name, value) {
        if (name === "searchCondition" && value) {
            if (value instanceof index_ts_1.NCMBQuery) {
                return this.set(name, value._where);
            }
    ...
    NCMBPush.open = function (deviceType, deviceToken, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        r = new index_ts_1.NCMBRequest;
                        r.body = { deviceType: deviceType, deviceToken: deviceToken };
                        return [4 /*yield*/, NCMBPush.ncmb.request.exec("POST", "/" + index_ts_1["default"].version + "/push/" + id + "/openNumber")];
                    case 1:
                        json = _a.sent();
