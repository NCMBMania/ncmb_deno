...
var NCMBUser = /** @class */ (function (_super) {
    ...
    NCMBUser.signUp = function (userName, password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.signUpWith({ userName: userName, password: password })];
            });
        });
    };
    ...
    NCMBUser.signUpWith = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var json, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, NCMBUser.ncmb.request.exec('POST', '/users', {}, params)];
                    case 1:
                        json = _a.sent();
                        user = new NCMBUser();
    ...
    NCMBUser.loginAsAnonymous = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.signUpWith({
                        authData: {
                            anonymous: {
                                id: uuid
                            }
